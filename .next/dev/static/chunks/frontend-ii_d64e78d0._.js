...
function CRMPage() {
    ...
    const handleConvertLead = async (lead)=>{
        ...
        if (error) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2d$ii$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao converter lead");
            return;
        }
        await supabase.from("lead_logs").insert({
            lead_id: lead.id,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2d$ii$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Lead convertido com sucesso!");
        fetchLeads();
    };
    const handleUnconvertLead = async (lead)=>{
        ...
        if (error) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2d$ii$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao desconverter lead");
            return;
        }
        await supabase.from("lead_logs").insert({
            lead_id: lead.id,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2d$ii$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Lead desconvertido com sucesso!");
        fetchLeads();
    };
